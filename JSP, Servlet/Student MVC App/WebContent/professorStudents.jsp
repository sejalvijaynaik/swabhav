...
<form method = "get" action = "professorSearchController">
...
<table border = "1">
	...
	for(int i = 0; i < students.size(); i++){
		...
		out.println("<td>");
		out.println("<form method = 'get' action = 'ProfessorPrepopulateController'>");
		out.println("<input type = 'hidden' name = 'studentId' value =" + students.get(i).getId() + ">");
		out.println("<input type = 'submit' value = 'update cgpa'></td>");
		out.println("</form>");
		out.println("</td>");
		out.println("</tr>");
	}
